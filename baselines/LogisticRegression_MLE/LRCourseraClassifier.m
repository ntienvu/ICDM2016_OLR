function theta = LRCourseraClassifier(X, y, numLabels, lambda)
...
options = optimset('MaxIter',50,'Display','none'); % used in fmincg
...
for i=1:numLabels
    ...
    expression='fmincg(@(t)(cost(t,X,yTemp,lambda)),initialTheta,options)';
    tempTheta(:,i) = eval(expression);
