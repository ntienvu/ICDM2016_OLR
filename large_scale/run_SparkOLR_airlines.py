...
MODEL_NAME = "SparkOLR_airlines"
D = 857
K = 2
NUM_TRAIN_PARTITIONS = 1000
NUM_TEST_PARTITIONS = 120
MAX_DISTANCE = 4983.0

DATA_DIR = "data"
DATA_FILE_TRAIN = "1987_to_2008_train90"
DATA_FILE_TEST = "1987_to_2008_test90"
...
if __name__ == "__main__":
    conf = SparkConf().setAppName("[TRAIN] {} for Airlines delay or not".format(MODEL_NAME))
    ...
    w = 1.0*np.ones((K, D))
    data = data.map(lambda batch: sample_polygam(batch[0], batch[1], w)).cache()
