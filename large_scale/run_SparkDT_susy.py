...
if __name__ == "__main__":
    ...
    for threshold in np.arange(min_prob, max_prob, (max_prob-min_prob)/10):
        ...
        # Threshold=0.4630  Precision=0.8389    Recall=0.6683   F1=0.7440   Accuracy=0.7358
        # Threshold=0.5520  Precision=0.6927    Recall=0.7760   F1=0.7320   Accuracy=0.7679
        # Threshold=0.6411  Precision=0.6455    Recall=0.8158   F1=0.7207   Accuracy=0.7711
