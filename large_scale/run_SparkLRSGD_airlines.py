...
MODEL_NAME = "SparkLRSGD_airlines"
...
if __name__ == "__main__":
    conf = SparkConf().setAppName("[TRAIN] LogReg with SGD for Airline Delay Prediction")
    ...
    model = LogisticRegressionWithSGD.train(data, iterations=100, step=0.1, regType=None, intercept=True)
    ...
    for threshold in np.arange(min_prob, max_prob, (max_prob-min_prob)/10):
        ...
        # Threshold=0.30, Precision=0.49, Recall=0.19, F1=0.27, Accuracy=0.57
