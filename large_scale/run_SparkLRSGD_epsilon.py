...
if __name__ == "__main__":
    ...
    model = LogisticRegressionWithSGD.train(data, iterations=50, step=0.1, regType="l2", regParam=0.1, intercept=True)
    ...
    for threshold in np.arange(min_prob, max_prob, (max_prob-min_prob)/10):
        ...
        # Threshold=0.6434, Precision=0.7938, Recall=0.5032, F1=0.6159, Accuracy=0.5055
